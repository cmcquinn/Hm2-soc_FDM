...
def setup_motion(kinematics='trivkins'):
    ...
    #    c.find('HOSTMOT2', 'CONFIG')) # "firmware=zynq/dtbo/prototype_7z020_ol.dtbo num_pwmgens=2 num_stepgens=2"
    os.system('halcmd newinst {driver} {instname} -- config="{config}"'.format(
