...
#   REPLICOOKIE.PY
#
#   Python configuration file for the Replicookie Snickerdoodle base board
#
#   This script instantiates and sets up MachineKit components for all of the physical
#   components on the Replicookie board
#
###################################################################################
